...
export default function Header() {
    ...
    function handleSubmit(e: SubmitEvent<HTMLFormElement>) {
        ...
        //TODO: Validar
        if(Object.values(searchFilter).every(value => value === "")) {
            showNotification({
            ...
            <div className="mx-auto container px-5 py-16">
                <div className="flex justify-between items-center">
                    ...
                    <nav className="flex gap-4">
                        ...
                        <NavLink className={({ isActive }) => isActive ? "text-orange-500 uppercase font-bold" : "text-white uppercase font-bold"} to="/favorites">Favoritos</NavLink>
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <input
                                ...
                                placeholder="Nombre o Ingrediente. Ej: Café, Leche"
                        ...
                        <input
                            ...
                            className=" cursor-pointer bg-orange-800 hover:bg-orange-900 w-full p-2 font-extrabold rounded-lg text-white uppercase"
                        />
                    </form>
                )}
            </div>
